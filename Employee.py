...
ICP 3
author: VENKATAGURUSWAMY GODHA
student ID: 700740474
email: vxg04740@ucmo.edu
...
def main():
    employees = []
    ftEmployee1 = FulltimeEmployee("Venkat", "Godha", 140000, "Software Engineering")
    ftEmployee1.full_time_member()
    employees.append(ftEmployee1)
    ftEmployee2 = FulltimeEmployee("Gopi", "Appasani", 170000, "Cyber Security")
    employees.append(ftEmployee2)
    employee1 = Employee("Bhargav", "Madala", 150000, "Testing")
    employees.append(employee1)
    employee2 = Employee("Pavan", "Mannem", 192000, "Product Manager")
